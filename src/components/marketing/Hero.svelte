      ...
      <div>
        <nav class="flex h-9 items-center justify-between" aria-label="Global">
          ...
          <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
            <a href="/dashboard" class="inline-block rounded-lg px-3 py-1.5 text-sm font-semibold leading-6 text-gray-900 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20">Dashboard</a>
          </div>
        </nav>
      ...
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
          <div>
            ...
            <div>
              <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Todo with Svelte</h1>
